...
function init_main_page_inputs($customizer){
    ...
    $customizer->add_setting(
    'input_middle_image',
    array('default' => 'http://fond-lider.r01host.ru/wp-content/themes/LeaderTheme/img/top-pic2.jpg')
    );
    // контрол
    $customizer->add_control(
    'input_middle_image',
    ...
    $customizer->add_setting(
    'input_right_image',
    array('default' => 'http://fond-lider.r01host.ru/wp-content/themes/LeaderTheme/img/top-pic3.jpg')
    );
    // контрол
    $customizer->add_control(
    'input_right_image',
